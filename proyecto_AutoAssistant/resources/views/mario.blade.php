...
<head>
  ...
  <style>
    ...
    body {
      ...
      height: 2000px; /* Establece un ancho máximo para el cuerpo de la página */
      margin: 0 auto; /* Centra el cuerpo de la página horizontalmente */
    ...
    .option-box:last-child {
      border-top-left-radius: 0; /* Eliminar redondeo en la esquina superior izquierda */
      border-bottom-left-radius: 0; /* Eliminar redondeo en la esquina inferior izquierda */
    }
  </style>
</head>
<body>
