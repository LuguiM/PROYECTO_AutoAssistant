...
.card_p:hover {
    ...
    /* Restaura el nivel de brillo normal */
}

.card_p:hover .card_title_p {
    color: initial;
    /* Restaura el color del texto normal */
}
...
<main class=" background-image">
    ...
    <div class="container">
        <div class="row justify-content-center background-image">
            <!-- Agrega la clase justify-content-center aquí -->
            <div class="col-md-8">
                        ...
                        <form action="{{ route('publicaciones.busscar') }}" method="GET">
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="text" name="q" class="form-control select_b"
                                        placeholder="Nombre del piloto" value="{{ request('q') }}">
                                </div>
                                <div class="col">
                                    <!-- Elimina el <br> para que los elementos se alineen horizontalmente -->
                                    <br>
                                    <div class="btn-group" role="group">

                                        <button type="submit" class="btn btn-primary">Buscar</button>
                                        <a href="{{ route('publicaciones.otravista') }}"
    ...
    <div class="row ">
        ...
        <div class="col-md-3">
            <div class="card mb-5 shadow-sm card_p">
                <img class="card-img-top card_img" src="{{ asset($publicacion->imagen) }}"
                    alt="{{ $publicacion->titulo }}" href="{{ route('publicaciones.show1', $publicacion->id) }}">
                <div class="card-body">
                    <h5 class="card-title card_title_p">{{ $publicacion->titulo }}</h5>
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <a href="{{ route('publicaciones.show1', $publicacion->id) }}"
