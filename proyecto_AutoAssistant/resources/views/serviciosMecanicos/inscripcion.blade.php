    ...
    <x-app-layout>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-2">
                    ...
                    <div class="form-floating col-md-12">
                        ...
                        <x-input-error :messages="$errors->get('nombreTaller')" class="alert alert-danger"
                            role="alert" />
                    </div>
                    <br>
                    <div class="form-floating col-md-12">
                        ...
                        <x-input-error :messages="$errors->get('fechaInicio')" class="alert alert-danger"
                            role="alert" />
                    </div>
                    <br>
                    <div class="form-floating col-md-12">
                ...
                <div class="col-md-2">
                    ...
                    <div class=" form-floating col-md-12">
                        ...
                        <x-input-error :messages="$errors->get('representante')" class="alert alert-danger"
                            role="alert" />
                    </div>
                    ...
                    <div class="form-floating col-md-12">
                        ...
                        <x-input-error :messages="$errors->get('numeroContacto')" class="alert alert-danger"
                            role="alert" />
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-floating col-12">
                        ...
                        <x-input-error :messages="$errors->get('descripcion')" class="alert alert-danger"
                            role="alert" />
                    </div>
                    <br>
                    <div class="form-floating col-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="file" class="form-control" id="acreditacion_1" name="acreditacion_1"
                            accept=".png, .jpg, .jpeg">
                        <x-input-error :messages="$errors->get('acreditacion_1')" class="alert alert-danger"
                            role="alert" />
                    </div>
                    @if(session('success'))
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            horarioInputs.forEach(input => {
                const minDateFormatted = currentDate.toISOString().slice(0,
                    16); // Formato YYYY-MM-DDTHH:mm
...
<form action="{{ route('servicios-mecanicos.store') }}" method="POST" enctype="multipart/form-data" class="container">
    <div class="row g-3">
        ...
        <div class="col-md-2">
            ...
            <div class="form-floating col-md-12">
                <label for="horario_fin">Horario de Fin</label>
                <input type="datetime-local" class="form-control" id="horario2" name="horario2"
