...
<body>
    <div class="registration-form">
        <form>
            ...
            <div class="form-group">
                <input type="text" class="form-control item" id="numero_licencia" placeholder="Numero de Licencia">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input type="password" class="form-control item" id="2contrasena" placeholder="Confirmar Contraseña">
            </div>
            <div class="form-group">
